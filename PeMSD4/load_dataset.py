...
def load_topo_dataset(topo_data_type):
    ...
    topo_train_data = np.load(path + '/data/PEMS04/PEMSD' + topo_data_type + '_ZFC_' + 'train' + '_data.npz', allow_pickle = True)['arr_0']
    topo_val_data = np.load(path + '/data/PEMS04/PEMSD' + topo_data_type + '_ZFC_' + 'validation' + '_data.npz', allow_pickle=True)['arr_0']
    topo_test_data = np.load(path + '/data/PEMS04/PEMSD' + topo_data_type + '_ZFC_' + 'test' + '_data.npz', allow_pickle=True)['arr_0']
