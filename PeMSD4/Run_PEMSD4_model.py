...
from ZFCSHGCNETs import ZFCSHGCRNCNN as Network
...
Mode = 'train'
DEBUG = 'True'
DATASET = 'PEMSD4' #PEMSD4, PEMSD8
DEVICE = 'cuda:0'
MODEL = 'ZFCSHGCNETs'
topo_data_type = '4' # 4 for PEMSDX dataset
...
args.add_argument('--num_edges', default=config['data']['num_edges'], type=int) # add num_edges information
...
#load dataset
train_loader_0, train_loader_1, val_loader_0, val_loader_1, test_loader_0, test_loader_1, scaler = get_topo_dataloader(args, topo_data_type,
...
#start training
trainer = Trainer(model, loss, optimizer, train_loader_0, train_loader_1, val_loader_0, val_loader_1, test_loader_0, test_loader_1, scaler,
